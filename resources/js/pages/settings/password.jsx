...
export default function Password() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={t('settings_password')} />

            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall title={t('settings_password')} description={t('settings_password')} />
                    ...
                    <form method="POST" onSubmit={updatePassword} className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            <Button disabled={processing}>{t('settings_password')}</Button>
